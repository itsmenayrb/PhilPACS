<?php
  ...
  $stmt = $config->runQuery("SELECT
                      ...
                      personaldetailstbl.birthday, personaldetailstbl.age, personaldetailstbl.photo AS profilePicture, IF (employeetbl.jobStatus = 1, 'Regular', 'Probationary') AS jobStatus, employeetbl.dateHired,
...
<div class="row mb-4">
  ...
  <a class="float-right btn btn-teal" data-toggle="tooltip" title="Edit Employee Details" href="./employee.php?edit=<?=$personalID;?>">
  ...
  <div class="col-md-9">
    ...
    <div class="card card-profile">
      ...
      <div class="card-body text-center">
        <img class="card-profile-img avatar avatar-xxl" src="<?=$displayPicture;?>">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    while ($sssRow = $sss->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      $rangeOfCompensationTo  = floatval(preg_replace("/[^-0-9\.]/", "", $rangeOfCompensationTo));
