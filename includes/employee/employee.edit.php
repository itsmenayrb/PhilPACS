      ...
      <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="card mb-1">
          <div class="card-body pb-1">
            <div class="row">
              <div class="col-auto">
                  <img src="<?=$profilePicture?>" class="avatar avatar-md" />
              </div>
              <div class="col">
                <div class="form-group">
                  <div class="custom-file pb-0">
                    <input type="file" class="custom-file-input" name="edit_profilePicture" id="edit_profilePicture" />
      ...
      <div class="col-md-4 col-xs-12 col-sm-12">
        ...
        <div class="row">
          <div class="col-md-12 col-xs-12">
            <div class="card text-white bg-lime mb-1">
              <div class="card-body p-3">
                 <h6 class="card-title"><i class="fe fe-linkedin"></i> Employment Details</h6>
              </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="edit_probationary">Probationary</label>
                        </div>
                    </div>
                </div>
