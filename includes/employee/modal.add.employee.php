                            ...
                            <div class="tab-pane active" id="personalDetailsTab" role="tabpanel">
                                <div class="p-3">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="form-label">Address<span class="text-danger">*</span> <small><i>(Leave it blank if not applicable.)</i></small></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-xs-12">
                                                <div class="form-group">
                                                     ...
                                                     <input type="text" maxlength="4" name="zipcode" class="required form-control" id="zipcode"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="offset-md-3 col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="date_hired" name="date_hired" />
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-5 col-xs-12">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="probationary">Probationary</label>
                                                </div>
                                            </div>
                                        </div>
