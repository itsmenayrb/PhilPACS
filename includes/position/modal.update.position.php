              ...
              <div class="dimmer active">
                ...
                <div id="update-dimmer-content">
                  <form class="m-t-40" id="updatePositionForm" action="<?= htmlspecialchars($_SERVER['REQUEST_URI']); ?>" method="post">
                      ...
                      <div class="row">
                          <div class="col-md-4 col-xs-12">
                              <div class="form-group">
                                   ...
                                   <input type="text" class="required form-control" id="update_code" placeholder="A/B/C/D" autofocus="true" required/>
                                   <span id="update_code_error" class="invalid-feedback"></span>
                              </div>
                          </div>
                          <div class="col-md-8 col-xs-12">
                              <div class="form-group">
                                   ...
                                   <span id="update_position_name_error" class="invalid-feedback"></span>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                           <label class="form-label" for="update_amount">Basic Salary<span class="text-danger">*</span></label>
                           <input type="text" class="required form-control" id="update_amount" placeholder="0.00" autofocus="true" required/>
                           <span id="update_amount_error" class="invalid-feedback"></span>
                      </div>
