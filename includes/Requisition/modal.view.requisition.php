                                          ...
                                          <div class='p-3'>
                                              ...
                                              <div class='container'>
                                                  ...
                                                  <div class='form-group'>
                                                       ...
                                                       <input type="text" class='form-control require' id='reason' style="height:60px" disabled>
                                                    ...
                                                    <div class='tab-pane active'role='tabpanel'>
                                                        <div class='p-3'>
                                                            <div class='container'>
                                                                ...
                                                                <div class='form-group'>
                                                                     <label class='form-control-label'>Reason</label>
                                                                     <input type="text" class='form-control require' id='reason_type' style="height:60px" disabled>
